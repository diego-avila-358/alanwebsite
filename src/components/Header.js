  ...
  return (
    <div className='header' style={{minWidth: '1110px'}}>
      <nav className="navbar navbar-expand-lg justify-content-center" style={{margin: 0, padding: 0}}>
        <div className="header-container" style={{display: 'flex', justifyContent: 'center', minWidth: 'inherit'}}>
            <ul className="navbar-nav" style={{minWidth: 'inherit', justifyContent: 'space-between'}}>
